...
import { TrendingUp, TrendingDown, DollarSign, PieChart, BarChart3, Plus, Wallet, Target } from 'lucide-react'
        ...
        <div className="card">
          <div className="flex items-center">
            ...
            <div className="ml-4">
              ...
              <p className={`text-2xl font-bold ${getPerformanceColor(portfolio.total_change_24h)}`}>
        ...
        <div className="card">
          <div className="flex items-center">
            ...
            <div className="ml-4">
              ...
              <p className={`text-2xl font-bold ${getPerformanceColor(portfolio.total_pnl)}`}>
          ...
          <table className="min-w-full divide-y divide-gray-200">
            ...
            <tbody className="bg-white divide-y divide-gray-200">
              {portfolio.holdings.map((holding, index) => {
                const pnl = (holding.current_price - holding.avg_buy_price) * holding.amount
                const pnlPercentage = ((holding.current_price - holding.avg_buy_price) / holding.avg_buy_price) * 100
                ...
                return (
                  <tr key={index} className="hover:bg-gray-50">
                    ...
                    <td className="px-6 py-4 whitespace-nowrap text-sm">
                      <div className={`flex items-center ${getPerformanceColor(holding.change_24h)}`}>
                        {getPerformanceIcon(holding.change_24h)}
                        <span className="ml-1">{formatPercentage(holding.change_24h)}</span>
                      </div>
                    </td>
                    <td className="px-6 py-4 whitespace-nowrap text-sm">
        ...
        <div className="card">
          ...
          <div className="space-y-4">
            ...
            <div className="flex justify-between">
              ...
              <span className={`text-sm font-medium ${getPerformanceColor(portfolio.total_pnl)}`}>
                {formatCurrency(portfolio.total_pnl)}
              </span>
            </div>
            <div className="flex justify-between">
              ...
              <span className={`text-sm font-medium ${getPerformanceColor(portfolio.total_pnl)}`}>
                {formatPercentage((portfolio.total_pnl / (portfolio.total_value - portfolio.total_pnl)) * 100)}
              </span>
            </div>
          </div>
        </div>
