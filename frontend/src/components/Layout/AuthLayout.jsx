...
const AuthLayout = ({ children }) => {
  return (
    <div className="min-h-screen flex">
      {/* Left side - Branding */}
      <div className="hidden lg:flex lg:flex-1 lg:flex-col lg:justify-center lg:px-8 lg:py-12 bg-gradient-to-br from-blue-600 via-blue-700 to-indigo-800">
          ...
          <div className="space-y-6 text-white">
            <div>
              ...
              <p className="text-blue-100 text-lg leading-relaxed">
                ...
                analysis to make informed trading decisions in the
            ...
            <div className="space-y-4">
              <div className="flex items-start space-x-3">
                <div className="flex-shrink-0 w-2 h-2 bg-blue-300 rounded-full mt-2"></div>
                <div>
              ...
              <div className="flex items-start space-x-3">
                ...
                <div>
                  ...
                  <p className="text-blue-100 text-sm">
                    Custom notifications for price movements and market
                    conditions
                  </p>
                </div>
              </div>
