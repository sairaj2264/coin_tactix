...
import { TrendingUp, TrendingDown, Target, Play, Pause, Settings, BarChart3 } from 'lucide-react'
  ...
  return (
    <div className="space-y-4">
      {strategies.map((strategy) => (
        <div key={strategy.id} className="bg-white rounded-xl shadow-sm border border-gray-200 p-6 hover:shadow-md transition-shadow duration-200">
          <div className="flex items-center justify-between mb-4">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-4">
            <div>
              ...
              <p className="text-lg font-semibold text-gray-900">{strategy.symbol}</p>
            </div>
            <div>
              <p className="text-sm text-gray-600">Total Return</p>
              <p className={`text-lg font-semibold ${getPerformanceColor(strategy.performance.total_return)}`}>
          ...
          <div className="flex items-center justify-between pt-4 border-t border-gray-100">
            <div className="flex items-center space-x-4 text-sm text-gray-600">
              ...
              <span>Max Drawdown: {strategy.performance.max_drawdown.toFixed(1)}%</span>
            </div>
